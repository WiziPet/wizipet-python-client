...
class WpResponseCartesPetFriendlyPlaceDetailsDto(BaseModel):
    """
    WpResponseCartesPetFriendlyPlaceDetailsDto
    """ # noqa: E501
    data: Optional[CartesPetFriendlyPlaceDetailsDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in WpResponseCartesPetFriendlyPlaceDetailsDto) in the input: " + _key)

        _obj = cls.model_validate({
            "data": CartesPetFriendlyPlaceDetailsDto.from_dict(obj["data"]) if obj.get("data") is not None else None,
