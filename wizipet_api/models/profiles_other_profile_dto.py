...
class ProfilesOtherProfileDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "owner_id", "pet_name", "personality", "race_id", "picture_id", "gender", "birthday", "ville", "connection_status", "friend_count", "alerte_perte", "is_ignored"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ProfilesOtherProfileDto) in the input: " + _key)
