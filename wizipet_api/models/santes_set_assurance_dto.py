...
class SantesSetAssuranceDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["company_id", "company_name", "contract", "phone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SantesSetAssuranceDto) in the input: " + _key)
