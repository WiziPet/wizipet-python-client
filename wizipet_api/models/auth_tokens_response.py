...
class AuthTokensResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["access_token", "refresh_token", "token_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AuthTokensResponse) in the input: " + _key)
