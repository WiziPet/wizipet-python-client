...
class DiscussionsIsArchivedDto(BaseModel):
    """
    DiscussionsIsArchivedDto
    """ # noqa: E501
    is_archived: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["is_archived"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in DiscussionsIsArchivedDto) in the input: " + _key)
