...
class SantesAssuranceDto(BaseModel):
    """
    SantesAssuranceDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["company_id", "contract", "phone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SantesAssuranceDto) in the input: " + _key)
