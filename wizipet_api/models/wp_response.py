...
class WpResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["is_success", "error_code", "error_message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in WpResponse) in the input: " + _key)
