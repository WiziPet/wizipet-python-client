...
class AuthPatchPasswordDto(BaseModel):
    """
    AuthPatchPasswordDto
    """ # noqa: E501
    old_password: Optional[StrictStr] = None
    new_password: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["old_password", "new_password"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AuthPatchPasswordDto) in the input: " + _key)
