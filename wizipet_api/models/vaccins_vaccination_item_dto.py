...
class VaccinsVaccinationItemDto(BaseModel):
    """
    ...
    vaccin_id: Optional[UUID] = None
    vaccin_protocol: Optional[VaccinsVaccinProtocolDto] = None
    __properties: ClassVar[List[str]] = ["id", "date", "commentaire", "vaccin_id", "vaccin_protocol"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in VaccinsVaccinationItemDto) in the input: " + _key)

        _obj = cls.model_validate({
            "id": obj.get("id"),
            "date": obj.get("date"),
            "commentaire": obj.get("commentaire"),
            "vaccin_id": obj.get("vaccin_id"),
