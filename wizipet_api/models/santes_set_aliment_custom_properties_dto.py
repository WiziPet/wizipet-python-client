...
class SantesSetAlimentCustomPropertiesDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "proteine_brutes_percent", "matiere_grasse_percent", "cellulose_brutes_percent", "cendres_brutes_percent", "humidite_percent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SantesSetAlimentCustomPropertiesDto) in the input: " + _key)
