...
class MedicalAssistantsAssistantQueryDto(BaseModel):
    """
    MedicalAssistantsAssistantQueryDto
    """ # noqa: E501
    correlation_id: Optional[UUID] = None
    option_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["correlation_id", "option_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MedicalAssistantsAssistantQueryDto) in the input: " + _key)
