...
class PenseBetesSetPenseBeteVaccinationDto(BaseModel):
    """
    PenseBetesSetPenseBeteVaccinationDto
    """ # noqa: E501
    vaccin_id_list: Optional[List[UUID]] = None
    __properties: ClassVar[List[str]] = ["vaccin_id_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PenseBetesSetPenseBeteVaccinationDto) in the input: " + _key)
