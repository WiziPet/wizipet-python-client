...
class SantesOverviewSensibilitesDto(BaseModel):
    """
    SantesOverviewSensibilitesDto
    """ # noqa: E501
    valeur_reference_list: Optional[List[UUID]] = None
    __properties: ClassVar[List[str]] = ["valeur_reference_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SantesOverviewSensibilitesDto) in the input: " + _key)
