...
class AuthLoginWithAppleDto(BaseModel):
    """
    AuthLoginWithAppleDto
    """ # noqa: E501
    apple_jwt: Optional[StrictStr] = None
    client_id: Optional[StrictStr] = None
    client_secret: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["apple_jwt", "client_id", "client_secret"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if apple_jwt (nullable) is None
        # and model_fields_set contains the field
        if self.apple_jwt is None and "apple_jwt" in self.model_fields_set:
            _dict['apple_jwt'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AuthLoginWithAppleDto) in the input: " + _key)

        _obj = cls.model_validate({
            "apple_jwt": obj.get("apple_jwt"),
