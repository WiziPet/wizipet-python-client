...
class ProfilesGroupIdExtraDto(BaseModel):
    """
    ProfilesGroupIdExtraDto
    """ # noqa: E501
    admin_id: Optional[UUID] = None
    __properties: ClassVar[List[str]] = ["admin_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ProfilesGroupIdExtraDto) in the input: " + _key)
