...
class CartesGeocodeResultsDto(BaseModel):
    """
    CartesGeocodeResultsDto
    """ # noqa: E501
    results: Optional[List[GooglesGeocodeResultDto]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CartesGeocodeResultsDto) in the input: " + _key)

        _obj = cls.model_validate({
            "results": [GooglesGeocodeResultDto.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
