...
class ProfilesOtherProfilesListDto(BaseModel):
    """
    ProfilesOtherProfilesListDto
    """ # noqa: E501
    group_id_extra: Optional[ProfilesGroupIdExtraDto] = None
    has_more: Optional[StrictBool] = None
    count: Optional[StrictInt] = None
    continuation_token: Optional[StrictStr] = None
    data: Optional[List[ProfilesOtherProfileItemDto]] = None
    is_success: Optional[StrictBool] = None
    error_code: Optional[StrictStr] = None
    error_message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["group_id_extra", "has_more", "count", "continuation_token", "data", "is_success", "error_code", "error_message"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of group_id_extra
        if self.group_id_extra:
            _dict['group_id_extra'] = self.group_id_extra.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ProfilesOtherProfilesListDto) in the input: " + _key)

        _obj = cls.model_validate({
            "group_id_extra": ProfilesGroupIdExtraDto.from_dict(obj["group_id_extra"]) if obj.get("group_id_extra") is not None else None,
            "has_more": obj.get("has_more"),
            "count": obj.get("count"),
            "continuation_token": obj.get("continuation_token"),
            "data": [ProfilesOtherProfileItemDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
