...
class SantesAlimentDto(BaseModel):
    """
    SantesAlimentDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "name", "proteine_brutes_percent", "matiere_grasse_percent", "cellulose_brutes_percent", "cendres_brutes_percent", "humidite_percent", "catalogue_properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SantesAlimentDto) in the input: " + _key)
