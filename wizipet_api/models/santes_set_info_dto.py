...
class SantesSetInfoDto(BaseModel):
    """
    SantesSetInfoDto
    """ # noqa: E501
    ...
    valeur_aliment: Optional[SantesSetAlimentDto] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SantesSetInfoDto) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "valeur_aliment": SantesSetAlimentDto.from_dict(obj["valeur_aliment"]) if obj.get("valeur_aliment") is not None else None,
