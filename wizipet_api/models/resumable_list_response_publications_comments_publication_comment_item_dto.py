...
class ResumableListResponsePublicationsCommentsPublicationCommentItemDto(BaseModel):
    """
    ...
    data: Optional[List[PublicationsCommentsPublicationCommentItemDto]] = None
    is_success: Optional[StrictBool] = None
    error_code: Optional[StrictStr] = None
    error_message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["has_more", "count", "continuation_token", "data", "is_success", "error_code", "error_message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ResumableListResponsePublicationsCommentsPublicationCommentItemDto) in the input: " + _key)

        _obj = cls.model_validate({
            "has_more": obj.get("has_more"),
            "count": obj.get("count"),
            "continuation_token": obj.get("continuation_token"),
            "data": [PublicationsCommentsPublicationCommentItemDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
