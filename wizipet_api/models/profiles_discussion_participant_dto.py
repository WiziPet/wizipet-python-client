...
class ProfilesDiscussionParticipantDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "pet_name", "race_id", "picture_id", "alerte_perte"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ProfilesDiscussionParticipantDto) in the input: " + _key)
