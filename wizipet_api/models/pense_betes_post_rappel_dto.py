...
class PenseBetesPostRappelDto(BaseModel):
    """
    PenseBetesPostRappelDto
    """ # noqa: E501
    var_date: Optional[StrictStr] = Field(default=None, alias="date")
    commentaire: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["date", "commentaire"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PenseBetesPostRappelDto) in the input: " + _key)
