...
class GroupsGroupDto(BaseModel):
    """
    GroupsGroupDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "ville", "description", "picture_id", "is_author", "is_subscribed", "is_highlighted", "member_count", "member_list_overview", "creation_date"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GroupsGroupDto) in the input: " + _key)
