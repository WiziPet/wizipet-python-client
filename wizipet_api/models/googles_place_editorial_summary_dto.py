...
class GooglesPlaceEditorialSummaryDto(BaseModel):
    """
    GooglesPlaceEditorialSummaryDto
    """ # noqa: E501
    language: Optional[StrictStr] = None
    overview: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["language", "overview"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GooglesPlaceEditorialSummaryDto) in the input: " + _key)
