...
class AuthRegisterUserRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["email", "client_id", "client_secret", "password"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AuthRegisterUserRequest) in the input: " + _key)
