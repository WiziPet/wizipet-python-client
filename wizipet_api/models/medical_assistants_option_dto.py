...
class MedicalAssistantsOptionDto(BaseModel):
    """
    MedicalAssistantsOptionDto
    """ # noqa: E501
    option_id: Optional[StrictStr] = None
    label: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["option_id", "label"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MedicalAssistantsOptionDto) in the input: " + _key)
