...
class ContactsContactSummaryDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["connection_status", "id", "pet_name", "picture_id", "race_id", "ville", "alerte_perte"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ContactsContactSummaryDto) in the input: " + _key)
