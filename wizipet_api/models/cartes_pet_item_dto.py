...
class CartesPetItemDto(BaseModel):
    """
    CartesPetItemDto
    """ # noqa: E501
    ...
    alerte_perte: Optional[CartesCartePerteDto] = None
    __properties: ClassVar[List[str]] = ["id", "image_id", "name", "race_id", "alerte_perte"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CartesPetItemDto) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "alerte_perte": CartesCartePerteDto.from_dict(obj["alerte_perte"]) if obj.get("alerte_perte") is not None else None
        })
        return _obj
