...
class PlacesListPlacesDto(BaseModel):
    """
    PlacesListPlacesDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["bounds", "sub_categories", "keywords", "continuation_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PlacesListPlacesDto) in the input: " + _key)
