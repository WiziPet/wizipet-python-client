...
class GooglesAddressComponentDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["long_name", "short_name", "types"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if long_name (nullable) is None
        # and model_fields_set contains the field
        if self.long_name is None and "long_name" in self.model_fields_set:
            _dict['long_name'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GooglesAddressComponentDto) in the input: " + _key)
